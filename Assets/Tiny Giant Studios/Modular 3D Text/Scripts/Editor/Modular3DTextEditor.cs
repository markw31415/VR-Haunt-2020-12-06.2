    ...
    public class Modular3DTextEditor : Editor
    {
        ...
        void AdvancedSettings()
        {
            ...
            if (showAdvancedSettings)
            {
                ...
                GUIContent hideLetters = new GUIContent("Hide letters in Hierararchy", "Hides the game object of letters in the hierarchy. They are still there just not visible. No impact except for cleaner hierarchy.");
